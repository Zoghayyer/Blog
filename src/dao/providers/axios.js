...
// ------------------------------------
/**
 * Create a baseline axios instance for use with the blogApp. A baseline axios instance:
 ...
 */
export const blogClient = createBaselineInstance(baseUrls.myBlogServer.url);